    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/doctors/**").hasAnyRole("ADMIN", "DOCTOR", "PATIENT", "RECEPTIONIST")
                .requestMatchers("/api/v1/patients/**").hasAnyRole("ADMIN", "DOCTOR", "NURSE", "RECEPTIONIST", "PATIENT")
                .requestMatchers("/api/v1/appointments/**").hasAnyRole("ADMIN", "DOCTOR", "NURSE", "RECEPTIONIST", "PATIENT")
                .requestMatchers("/api/v1/medical-records/**").hasAnyRole("ADMIN", "DOCTOR", "NURSE")
